...
<div class="card">
    <div class="card-header">
        <div class="form-row">
            ...
            <div class="col-4 text-right">
                <a href="<?= url('bodega/') ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="left" title="Regresar">
    ...
    <form action="<?= url('reempacado/actualizar/id') ?>" id="frm-registro-entrada" method="post">
        <input type="hidden" name="codigo_reempacado" value="<?= $coder ?>">
        <input type="hidden" name="clave" value="<?= $passcode ?>">
    </form>
