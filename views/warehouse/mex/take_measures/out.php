...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form action="<?= url("bodega/actualizar/{$measure_entry_mex->id}/{$coming}") ?>" method="post">
            ...
            <button class="btn btn-success" type="submit">Actualizar medidas de salida</button>
        </form>
    </div>
</div>
<p class="text-right">
    <a href="<?= url($go_home) ?>" class="text-danger">[ Cancelar actualizacion de medidas de salida ]</a>
</p>
<?php $template->stop() ?>
